...
object JsonSerializable {
  ...
  implicit val intSerializable: JsonSerializable[Int] = new JsonSerializable[Int] {
    def toJson(a: Int): JsonValue = JsonNumber(a)
  }

  implicit val stringSerializable: JsonSerializable[String] = new JsonSerializable[String] {
    def toJson(a: String): JsonValue = JsonString(a)
  }

  implicit val booleanSerializable: JsonSerializable[Boolean] = new JsonSerializable[Boolean] {
    def toJson(a: Boolean): JsonValue = JsonBoolean(a)
  }

  implicit def optionSerializable[A : JsonSerializable]: JsonSerializable[Option[A]] = new JsonSerializable[Option[A]] {
  ...
  implicit def listSerializable[A : JsonSerializable]: JsonSerializable[List[A]] = new JsonSerializable[List[A]] {
